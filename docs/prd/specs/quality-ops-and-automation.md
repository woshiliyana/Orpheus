...
|---|---|
| `quality_scorecard` | The fixed set of quality metrics used to judge render, voice, long-audio, and subtitle performance |
...
| `provider_health` | Run success, failure stages, latency, and long-audio stability by provider |
...
| `subtitle_quality` | SRT success rate, alignment quality, and retry outcomes |
...
3. Roadmap phases may sequence these systems, but they must reference this spec for what the systems mean.
