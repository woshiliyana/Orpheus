...
公开价格、年付折扣、included minutes 和 unit-economics review 统一以 `docs/prd/specs/pricing-packaging-and-unit-economics.md` 为准。
...
2. 免费层首先负责让用户理解“稳定长文本出音频”的价值，而不是先强调大量音色选择
...
2a. `ElevenLabs Studio` 也说明 Orpheus 不能只用“能做长文本”来定义自己；如果没有更低操作负担、解释型创作者适配和更强的字幕 / 对齐资产价值，公开 self-serve 会显得像更小的替代品。
