...
|---|---|---|---|---|---|
| `Phase 0` | Freeze truth system and ratify quality/automation truth | Prevents semantic drift before code work starts | Experience, Workflow, QualityOps | Mostly sequential | [phase-00-truth-freeze-quality-scorecard](./phases/phase-00-truth-freeze-quality-scorecard.md) |
| `Phase 1` | Launch high-quality experience foundation and platform shell | UX, brand, and shell must start immediately, not after backend | Experience, Workflow | Experience and shell scaffolding can run together | [phase-01-experience-foundation-platform-shell](./phases/phase-01-experience-foundation-platform-shell.md) |
| `Phase 2` | Deliver core render workflow | First real product value is long-form audio generation | Workflow, Experience | Limited parallelism; keep project/run semantics unified | [phase-02-core-render-workflow](./phases/phase-02-core-render-workflow.md) |
...
| `Phase 7` | Ship public site, SEO, and localized growth surface | Public promises must match real capability | Experience, Workflow | Can fan out across locales once core truth is stable | [phase-07-public-site-seo-localized-growth](./phases/phase-07-public-site-seo-localized-growth.md) |
